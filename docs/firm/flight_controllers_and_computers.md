...
Flight controller software generally focuses on collecting sensor data, logging data, and transmitting data via USB, radio, UART, or similar protocols. The code loops quickly to ensure dependent systems can respond to real-time events fast enough.
