...
As one of the lowest priced COTS Altimeter-Tracker for hobby rocketry, the **[Eggtimer Quasar](https://eggtimerrocketry.com/home/altimeters-av-bay/)** is a WiFi-enabled device that allows remote charge deployment, stage ignition, and tracking.
